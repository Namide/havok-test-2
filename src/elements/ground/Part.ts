...
import { GROUND_ROCKS_MAX_COUNT, GROUND_ROCKS_MIN_COUNT, GROUND_SIZE } from "../../config"
...
export class Part {
  ...
  constructor(world: World, x: number, y: number, material: THREE.Material) {
    ...
    this.physic = new PhysicGroundPart(this.world, position, this.render.object3d.geometry)

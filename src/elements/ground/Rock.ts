...
import {
  ...
  Quaternion,
  Vector3,
} from "../../engine/physic/havok/HavokPhysics";
    ...
    loadGLTF("assets/rock-base.glb").then((gltf) => {
      gltf.scene.traverse((object) => {
        ...
        if (mesh.name === "Plane") {
          ...
          // Update
          const transform = this.world.physic.havok.HP_Body_GetQTransform(
            this.body,
          )[1];
